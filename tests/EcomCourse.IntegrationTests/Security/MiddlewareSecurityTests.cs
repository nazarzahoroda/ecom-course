...
public class MiddlewareSecurityTests : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _client;

    public MiddlewareSecurityTests(CustomWebApplicationFactory factory)
    {
    ...
    public async Task Authenticate_ShouldReturnProblemDetails_WhenTokenIsMalformed()
    {
        ...
        request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", "invalid.malformed.jwt.token");
